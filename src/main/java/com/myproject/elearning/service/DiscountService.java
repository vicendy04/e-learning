...
import com.myproject.elearning.dto.response.discount.DiscountResponse;
...
// dùng token để lấy email của instructor
    ...
    @Transactional
    public DiscountResponse generateDiscountCode(String instructorEmail, DiscountCreateRequest request) {
